...
- Os assinantes da newsletter desejam se cadastrar facilmente para acompanhar novidades.
...
- Formulário para cadastro na newsletter;
- Formulário para manifestação de interesse em se tornar associado.
...
- O sistema deve permitir o cadastro de usuários na newsletter;
- O sistema deve permitir que usuários manifestem interesse em se tornar associados;
- O sistema deve permitir que colaboradores publiquem novos conteúdos ao longo do tempo.

Requisitos não funcionais
- O site deve possuir interface clara, profissional e de fácil navegação;
- O sistema deve ser responsivo, funcionando adequadamente em computadores e dispositivos móveis;
- O site deve apresentar bom desempenho de carregamento;
- O sistema deve garantir segurança básica no envio de dados em formulários;
- O conteúdo deve ser organizado de forma acessível e intuitiva para os usuários.

6. Restrições e Premissas

Restrições
- O projeto será desenvolvido dentro do prazo definido pela disciplina;
- O sistema deverá ser implementado com as tecnologias definidas pela equipe ou exigidas pela matéria;
- O escopo inicial será limitado às funcionalidades principais descritas neste documento;
...
Riscos
- Possível atraso no desenvolvimento devido ao tempo limitado do projeto;
- Mudanças nos requisitos ao longo da execução;
- Dificuldade em organizar ou obter todo o conteúdo institucional necessário;
...
2. [Mind Map](./Documentação/Mind_Map/Mind%20Map%20ABC%20Brasil.png) (Pronto)
3. [Documento de Visão](./Documentação/documento_de_visao.md) (Pronto)
4. [Brainstorm](./Documentação/BRAINSTORM.txt) (Pronto)
5. [Prototipo Figma](https://www.figma.com/proto/9w5kkZqt8DPw1cc64a9b17/Prot%C3%B3tipo?node-id=199-3&t=gUmnTGJAicxLdS5A-1) (Pronto)
6. [Scrum](./Documentação/scrum%20meentings/Reuniões.txt) (Pronto)